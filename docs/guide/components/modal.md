...
| noticeProps | 通知按钮 `props` 配置，参考 [Button Props](https://Kitesource.github.io/composed-ui/guide/components/button.html#button) | object | {} |
...
| cancelProps? | 取消按钮 `props` 配置，参考 [Button Props](https://Kitesource.github.io/composed-ui/guide/components/button.html#button) | object | undefined |
| okText? | 确认按钮文字 | string | undefined |
| okType? | 确认按钮类型 | 'default' &#124; 'reverse' &#124; 'primary' &#124; 'danger' &#124; 'dashed' &#124; 'text' &#124; 'link' | undefined |
| okProps? | 确认按钮 `props` 配置，优先级高于 `okType`，参考 [Button Props](https://Kitesource.github.io/composed-ui/guide/components/button.html#button) | object | undefined |
| noticeText? | 通知按钮文字 | string | undefined |
| noticeProps? | 通知按钮 `props` 配置，参考 [Button Props](https://Kitesource.github.io/composed-ui/guide/components/button.html#button) | object | undefined |
