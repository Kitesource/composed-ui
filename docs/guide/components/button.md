...
<Space vertical>
  ...
  <Space>
    <Tooltip tooltip="search">
      <Button href="https://Kitesource.blog.csdn.net" target="_blank">
        <template #icon>
          <SearchOutlined />
        </template>
      </Button>
...
<Space>
  <Button type="primary" ghost href="https://Kitesource.github.io/composed-ui/" target="_blank">
    <template #icon>
      <img
        style="width: 1em; height: 1em"
        src="https://Kitesource.github.io/composed-ui/composed-logo.svg"
      />
    </template>
   Composed UI
  </Button>
  <Button
    type="primary"
    href="https://Kitesource.github.io/composed-ui/guide/components/button.html"
    target="_blank"
  >
    Button Component
  </Button>
  <Button type="primary" ghost shape="round" href="https://Kitesource.blog.csdn.net" target="_blank">
    My CSDN Blogs
  </Button>
</Space>
...
<template>
  <Space>
    <Button type="primary" ghost href="https://Kitesource.github.io/composed-ui/" target="_blank">
      <template #icon>
        <img style="width: 1em; height: 1em" src="https://Kitesource.github.io/composed-ui/composed-logo.svg" />
      </template>
     Composed UI
    </Button>
    <Button
