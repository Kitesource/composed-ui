...
<Card width="100%" style="height: 300px; transform: translate(0)">
  <FloatButton href="https://Kitesource.github.io/composed-ui/" :right="96">
    <template #icon>
...
| badgeProps | 带徽标的浮动按钮（不支持 `status` 以及相关属性），参考 [Badge Props](https://Kitesource.github.io/composed-ui/guide/components/badge.html#badge) | object | {} |
