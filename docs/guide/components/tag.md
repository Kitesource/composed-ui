...
import type { TagItem } from 'composed-ui'
...
<Space gap="small">
  <Tag>Tag 1</Tag>
  <Tag><a href="https://Kitesource.blog.csdn.net">Link</a></Tag>
...
| spaceProps | `Space` 组件属性配置，参考 [Space Props](https://Kitesource.github.io/composed-ui/guide/components/space.html#space) ，仅当 `dynamic: true` 时生效 | object | {} |
