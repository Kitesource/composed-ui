...
export default defineConfig({
  title: `Composed UI`,
  description: 'Composed UI 组件库',
  base: '/composed-ui/',

  head: [
    // 网站图标
    ['link', { rel: 'icon', href: '/composed-ui/composed-icon.svg' }]
  ],
  ...
  themeConfig: {
    logo: '/composed-icon.svg',

    editLink: {
      pattern: 'https://github.com/Kitesource/composed-ui/tree/main/docs/:path',
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/Kitesource/composed-ui' },
      { icon: 'npm', link: 'https://www.npmjs.com/package/composed-ui' }
    ],
