/*
  ...
  return fetch('https://api.github.com/repos/Kitesource/composed-ui/contents/package.json?ref=main', {
    headers: {
  ...
  return fetch('https://raw.githubusercontent.com/Kitesource/composed-ui/main/package.json')
*/
