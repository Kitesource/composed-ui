...
<template>
  <div>
    ...
    <Space>
      <Popover :show-delay="300" :hide-delay="300" title="delay 300ms" content="Composed UI">
        <Button type="primary">Delay 300ms Popover</Button>
      </Popover>
      <Popover :show-delay="500" :hide-delay="500" title="delay 500ms" content="Composed UI">
